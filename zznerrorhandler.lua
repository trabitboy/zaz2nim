...
local function error_printer(msg, layer)
	print((debug.traceback("ZZN Error: " .. tostring(msg), 1+(layer or 1)):gsub("\n[^\n]+$", "")))
end
...
love.errorhandler= function (msg)
   ...
   p='we are very very sorry, press SPACE or TOUCH SCREEN  to save your whole project, ESC to quit '
...
function love.backerrorhandler(msg)
